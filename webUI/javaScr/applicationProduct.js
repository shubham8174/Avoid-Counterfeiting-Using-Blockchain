    ...
    registerProduct: function(event) {
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                return productInstance.addProduct(web3.fromAscii(manufacturerID),web3.fromAscii(productName), web3.fromAscii(productSN), web3.fromAscii(productBrand), productCost, {from:account});
