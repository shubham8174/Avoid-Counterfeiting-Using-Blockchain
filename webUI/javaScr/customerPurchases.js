    ...
    getData:function(event) {
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                return productInstance.getPurchaseHistory(web3.fromAscii(customerCode),{from:account});
                ...
                for(var k=0;k<result[1].length;k++){
                    retailerCodes[k]=web3.toAscii(result[1][k]);
                ...
                for(var i=0;i<result[0].length;i++) {
                    var temptr = "<td>"+retailerCodes[i]+"</td>";
                    if(temptr === "<td>0</td>"){
                        break;
                    }
                    var tr="<tr>";
                    tr+="<td>"+productSNs[i]+"</td>";
                    tr+="<td>"+retailerCodes[i]+"</td>";
